...
const translations = {
  en: {
    ...
    "admin.generate": "Generate Article",
    "admin.keywords": "Keywords",
    "admin.seoPreview": "SEO Preview",
    "admin.publish": "Publish",
    "admin.translate": "Translate",
    "admin.outline": "Generate Outline",
    "admin.ideas": "Generate Ideas",
  ...
  es: {
    ...
    "admin.generate": "Generar Artículo",
    "admin.keywords": "Palabras Clave",
    "admin.seoPreview": "Vista Previa SEO",
    "admin.publish": "Publicar",
    "admin.translate": "Traducir",
    "admin.outline": "Generar Esquema",
    "admin.ideas": "Generar Ideas",
